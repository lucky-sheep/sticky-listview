...
import com.yc.stickylistviewlibrary.caching.HeaderProvider;
import com.yc.stickylistviewlibrary.caching.HeaderViewCache;
import com.yc.stickylistviewlibrary.calculation.DimensionCalculator;
import com.yc.stickylistviewlibrary.rendering.HeaderRenderer;
import com.yc.stickylistviewlibrary.util.LinearLayoutOrientationProvider;
import com.yc.stickylistviewlibrary.util.OrientationProvider;
...
public class StickyRecyclerHeadersDecoration extends RecyclerView.ItemDecoration {
    ...
    public StickyRecyclerHeadersDecoration(
        ...
        this(adapter,
                new LinearLayoutOrientationProvider(),
                new DimensionCalculator(),
                visibilityAdapter);
    }

    private StickyRecyclerHeadersDecoration(
    ...
    private StickyRecyclerHeadersDecoration(
        ...
        this(adapter,
                ...
                dimensionCalculator,
                headerProvider,
                new HeaderPositionCalculator(adapter,
                        headerProvider,
                        orientationProvider,
                        dimensionCalculator),
                visibilityAdapter);
    ...
    public void onDrawOver(Canvas canvas, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (hasStickyHeader || mHeaderPositionCalculator.hasNewHeader(position,
                ...
                mHeaderPositionCalculator.initHeaderBounds(headerOffset,
                        parent,
                        header,
                        itemView,
                        hasStickyHeader);
    ...
    /**
     * Invalidates cached headers.  This does not invalidate the recyclerview, you should do that
     * manually after
     * calling this method.
     */
